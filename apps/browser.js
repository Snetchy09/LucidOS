        ...
        <div class="lucid-browser">
            ...
            <div class="browser-top">
                ...
                <div class="browser-brand">
                    <div class="browser-brand-symbol">
                        ◇
                    </div>

                    <div>
                        <div class="browser-brand-name">
                            lucid
                        </div>

                        <div class="browser-brand-version">
                            browser
                        </div>
                    </div>
                </div>
                ...
                <div class="browser-address-shell">
                    ...
                    <span class="browser-address-icon">
                        ◇
                    </span>
            ...
            <div class="browser-body">
                ...
                <aside class="browser-tabs">
                    ...
                    >
                        ...
                        <span class="browser-tab-text">
                            Home
                        </span>

                        <span class="browser-tab-close">
                            ×
                        </span>
