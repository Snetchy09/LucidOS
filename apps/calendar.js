...
function createCalendar() {
        ...
        <div class="lucid-calendar">
            ...
            <div class="calendar-layout">
                ...
                <aside class="calendar-sidebar">
                    <h3>Events</h3>
                    <div class="calendar-selected-date">Select a day</div>
                    <div class="calendar-events"></div>
                    <div class="calendar-event-form" hidden>
                        <input class="calendar-event-input" placeholder="Event name...">
                        <button class="calendar-add-event">Add event</button>
                    </div>
                </aside>
            </div>
        </div>
    ...
    let events = JSON.parse(localStorage.getItem("lucid_calendar_events") || "{}");
    ...
    function saveEvents() {
        localStorage.setItem("lucid_calendar_events", JSON.stringify(events));
    }
    ...
    function renderEvents() {
        ...
        selectedDate.textContent = selectedDay.toLocaleDateString(undefined, {
